...
pub const offsetof = @compileError("unable to translate C expr: unexpected token 'an identifier'"); // /Users/corysmith/zig/0.13.0-dev.35+e8f28cda9/files/lib/include/stddef.h:116:9
...
pub const SOKOL_GFX_API_DECL = @compileError("unable to translate C expr: unexpected token 'extern'"); // sokol_gfx.h:1576:9
pub const _SG_LOG_ITEMS = @compileError("unable to translate macro: undefined identifier `OK`"); // sokol_gfx.h:3524:9
pub const _SG_LOGITEM_XMACRO = @compileError("unable to translate macro: undefined identifier `SG_LOGITEM_`"); // sokol_gfx.h:3825:9
